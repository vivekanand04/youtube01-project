  ...
  return (
    <div className='play-video'>
      ...
      <div className='vid-description'>
        <p>{apiData ? apiData.snippet.description.slice(0, 250) : "descriptiion here"}</p>
        <hr />
        ...
        {/* <div className='comment'>
          ...
          <div>
            ...
            <p>A global computer network proviiding a variety of information and cc of interconnected networks using standerdized communications protocols</p>
            <div className='comment-action'>
              <img src={like} alt='' />
              <span>244</span>
              <img src={dislike} alt='' />
